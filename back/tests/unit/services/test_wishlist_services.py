...
def test_create_and_get_wishlist_service(db_session, sample_user):
    wishlist = wishlist_service.get_or_create_wishlist(db_session, sample_user.id)
...
def test_add_to_wishlist_service(db_session, sample_user, sample_product):
    ...
    wishlist = wishlist_service.add_to_wishlist(db_session, sample_user.id, data)
...
def test_remove_from_wishlist_service(db_session, sample_user, sample_product):
    ...
    wishlist_service.remove_from_wishlist(db_session, sample_user.id, sample_product.id)
