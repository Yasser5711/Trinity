...
def main():
        ...
        if 'products' in data:
            ...
            for product in products:
                try:
                    ...
                    print(f"Produit ajouté : {name} avec un prix de {round(price, 2)} €")
    ...
    try:
        ...
        print(f"Les données de {len(product_list)} produits ont été écrites dans {output_file}.")
    except IOError as e:
